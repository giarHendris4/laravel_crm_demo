                    ...
                    <div class="space-y-6">
                                ...
                                @if ($sales->count() > 0)
                                    <select name="user_id" id="user_id"
                                        ...
                                        @foreach ($sales as $salesUser)
                                            <option value="{{ $salesUser->id }}" {{ old('user_id') == $salesUser->id ? 'selected' : '' }}>
                                                {{ $salesUser->name }}
                                            </option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input type="number" name="total_lifetime_value" id="total_lifetime_value" step="0.01" value="{{ old('total_lifetime_value') }}"
                                       class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm" required>
